...
#### SimpleDelegator
The changes present in this fork changes the response from ActiveResource. ActiveResource wraps nil objects in SimpleDelegator class. This fork changes the response to return nil instead of SimpleDelegator(nil).
